<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create Room Type</h2>
    </x-slot>
                    ...
                    <form action="{{ route('room-types.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="base_price" name="base_price" type="number" step="0.01" min="0" class="block mt-1 w-full" value="{{ old('base_price') }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="image_url" name="image_url" type="url" class="block mt-1 w-full" value="{{ old('image_url') }}" />
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" name="is_active" value="1" {{ old('is_active', '1') ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
