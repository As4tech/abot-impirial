<x-app-layout>
    ...
    <div class="p-6 space-y-4">
        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
            <form method="POST" action="{{ route('expenses.categories.update', $category) }}" class="space-y-4 max-w-xl">
                @csrf
                @method('PUT')
                <div>
                ...
                <button class="bg-slate-900 hover:bg-slate-800 text-white px-4 py-2 rounded">Save</button>
            </form>
        </div>
    </div>
</x-app-layout>
