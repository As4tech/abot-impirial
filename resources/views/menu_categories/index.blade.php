<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Menu Categories</h2>
            <a href="{{ route('menu-categories.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">New Category</a>
        </div>
    </x-slot>
                ...
                @forelse ($categories as $category)
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right space-x-3">
                            <a href="{{ route('menu-categories.edit', $category) }}" title="Edit" class="inline-flex items-center text-blue-600 hover:underline">
                            ...
                            <form method="POST" action="{{ route('menu-categories.destroy', $category) }}" class="inline">
                                @csrf
                                @method('DELETE')
