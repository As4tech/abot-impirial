<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Inventory Category</h2>
    </x-slot>
        ...
        <div class="bg-white shadow-sm rounded-lg p-4">
            <form method="POST" action="{{ route('inventory.categories.update', $category) }}" class="space-y-4">
                ...
                <div class="flex justify-end gap-2">
                    <a href="{{ route('inventory.categories.index') }}" class="px-4 py-2 border rounded">Cancel</a>
