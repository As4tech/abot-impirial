    ...
    <div class="p-4 space-y-4">
        ...
        <form method="GET" class="flex flex-wrap gap-2 items-end">
            <div>
                ...
                <input type="text" name="search" value="{{ $search }}" placeholder="Search items..." class="border rounded px-3 py-2 w-60" />
            </div>
            <div>
        ...
        <div class="bg-white shadow-sm rounded-lg overflow-hidden">
            <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 text-right space-x-3">
                            ...
                            <form method="POST" action="{{ route('menu-items.destroy', $item) }}" class="inline">
                                @csrf
                                @method('DELETE')
                                <button title="Delete" class="inline-flex items-center text-red-600 hover:underline" onclick="return confirm('Delete this item?')">
                ...
                @empty
                    <tr>
                        <td class="px-4 py-6 text-gray-500" colspan="4">No items found.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
