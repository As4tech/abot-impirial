<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Menu Items Sales</h2>
    </x-slot>
    ...
    <div class="p-4 space-y-6">
        ...
        <div class="bg-white shadow-sm rounded-lg p-4">
            <canvas id="menuItemsChart" height="80"></canvas>
        </div>

        <div class="bg-white shadow-sm rounded-lg overflow-hidden">
            <div class="px-4 py-3 font-semibold">Top Menu Items</div>
    ...
    <script>
        ...
        const ctx = document.getElementById('menuItemsChart');
        new Chart(ctx, {
            type: 'line',
            data: {
                labels,
